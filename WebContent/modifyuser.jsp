  ...
  <body style="overflow-x:hidden;">
    ...
    <div class="container">
        ...
        <div class="col-md-12" style="margin-top:80px">
          ...
          <form class="form-horizontal modifyuser-control" role="form" id="modifyuserForm" name="modifyuserForm" action="ModifyUserServlet" method="post" onsubmit="return validate(this);">
            <!-- username -->
            <div class="form-group">
	...
	function validate(modifyuserForm) {
		...
		if (modifyuserForm.password.value.length<6 || modifyuserForm.password.value.length>20) {
			document.getElementById("myModalTitle").innerHTML = "修改失败";
			document.getElementById("myModalContainer").innerHTML = "密码长度必须在6-20之间";
               $("#myModal").modal();
			return false;
		}
		...
		if ((modifyuserForm.username.value == "${username}")&&(modifyuserForm.password.value == "${pwd}")) {
			document.getElementById("myModalTitle").innerHTML = "修改失败";
